...
Ice.loadSlice("-I ./generated/ --all ./generated/Recorder.ice")
import RoboCompRecorder
Ice.loadSlice("-I ./generated/ --all ./generated/Speech.ice")
...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.EmotionalMotor = self.create_proxy("EmotionalMotor", RoboCompEmotionalMotor.EmotionalMotorPrx, parameters["Proxies"]["EmotionalMotor"])
        self.Recorder = self.create_proxy("Recorder", RoboCompRecorder.RecorderPrx, parameters["Proxies"]["Recorder"])
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.speech = self.create_adapter("Speech", speechI.SpeechI(default_handler, ""), parameters["Endpoints"]["Speech"])
