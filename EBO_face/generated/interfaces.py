...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.emotionalmotor = self.create_adapter("EmotionalMotor", emotionalmotorI.EmotionalMotorI(default_handler, ""), parameters["Endpoints"]["EmotionalMotor"])
